  ...
  <div>
    ...
    <div id="loginFormContainer" class="loginFormContainer">
      <button class="closeLoginFormButton" @click="close">
        <svg fill="#232323" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24px" height="24px">
          <path
      ...
      <password-reset-form
          v-if="formType === 3"
          @back="this.formType = 2"
          @close="close"
      />
      <login-form
          v-if="this.formType === 2"
          @forgotPassword="this.formType = 3"
          @switch="switchForms"
          @close="close"
      />
      <reg-form
